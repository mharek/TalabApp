    ...
    <div className="container aboutus">
        <div className="row">
            ...
            <div className="col-md-6 col-12 my-auto">
                ...
                <p className="lead text-justify text-center">Eleve ingenieur cherche a s'aider entre eux pour trouver un colocataire assez rapide et assez parallele a son besoin.</p>
        ...
        <div className="row mb-5">
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={smail} className="card-img-top" alt="director" />
                    <div className="card-body">
                        <h5 className="card-title mb-0">Frontend Developer (React Js)</h5>
                        <div className="card-text text-black-50">ABID Ismail() <p className="float-right">Last year</p>
                        </div>
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={naoufal} className="card-img-top" alt="director" />
                    <div className="card-body">
                        <h5 className="card-title mb-0">Frontend Developer (React Js)</h5>
                        <div className="card-text text-black-50">ACHAHBAR Naoufal<p className="float-right">Last year</p>
                        </div>
                        <h6 className="mt-5">CONNECT</h6>
                        <div className="d-flex justify-content-around">
                            <FaFacebookSquare className="connect" />
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={mehdi} className="card-img-top" alt="director" />
                    <div className="card-body">
                        <h5 className="card-title mb-0">Frontend Developer (React Js)</h5>
                        <div className="card-text text-black-50">AIT-KADI El Mahdi <p className="float-right">Last year</p>
                        </div>
                        <h6 className="mt-5">CONNECT</h6>
                        <div className="d-flex justify-content-around">
                            <FaFacebookSquare className="connect" />
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={ayoub} className="card-img-top" alt="director" />
                    <div className="card-body">
                        <h5 className="card-title mb-0">Frontend Developer (React Js)</h5>
                        <div className="card-text text-black-50">M'HAREK Ayoub <p className="float-right">Last year</p>
                        </div>
                        <h6 className="mt-5">CONNECT</h6>
                        <div className="d-flex justify-content-around">
                            <FaFacebookSquare className="connect" />
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={taha} className="card-img-top" alt="director" />
                    <div className="card-body">
                        <h5 className="card-title mb-0">Backend Developer (Springboot)</h5>
                        <div className="card-text text-black-50">RAISSOUNI Taha <p className="float-right">Last year</p>
                        </div>
                        <h6 className="mt-5">CONNECT</h6>
                        <div className="d-flex justify-content-around">
                            <FaFacebookSquare className="connect" />
